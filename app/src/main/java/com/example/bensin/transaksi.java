...
public class transaksi extends AppCompatActivity {
    ...
    gridView=(RecyclerView)findViewById(R.id.list_trx);
        ...
        StringRequest stringRequest =new StringRequest(Request.Method.GET, URLs.URL_AMBIL_TRX, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    adapter=new adapter_transaksi(model_transaksiList);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(transaksi.this, LinearLayoutManager.VERTICAL,false);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(transaksi.this, "Koneksi Error,Buka dan Tutup Kembali Aplikasi", Toast.LENGTH_SHORT).show();
            }
        });
